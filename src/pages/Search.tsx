                ...
                {loading && results.length === 0 ? (
                    ...
                    !loading && query && (
                         <div className="flex flex-col items-center justify-center text-center py-12 md:py-20">
                            <img src="/lovable-uploads/70623c64-2a7b-48ad-beed-1bbfba185e3a.png" alt="Data Not Found" className="w-24 h-24 md:w-32 md:h-32 mb-4 md:mb-6" />
                            <h2 className="text-xl md:text-2xl font-bold text-white mb-2">Data Not Found</h2>
                            <p className="text-gray-400 text-sm md:text-base">Try other keywords</p>
                        </div>
                    )
                )}
