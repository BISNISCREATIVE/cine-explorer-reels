          ...
          <div className="hidden md:flex items-center space-x-4">
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-4 py-2 w-64 bg-gray-800/50 border-gray-700 text-white placeholder-gray-400 focus:border-blue-500 rounded-full"
              />
            </div>
          </div>
            ...
            <nav className="flex flex-col space-y-4">
              ...
              <div className="relative mt-4">
                ...
                <Input
                  ...
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="pl-10 pr-4 py-2 w-full bg-gray-800/50 border-gray-700 text-white placeholder-gray-400 focus:border-blue-500 rounded-full"
                />
              </div>
            </nav>
          </div>
